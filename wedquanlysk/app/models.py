...
class Register(models.Model):
    ...
    sodienthoai = models.IntegerField(db_column='Sodienthoai', unique=True)  # Field name made lowercase.
...
class AppEvent(models.Model):
    ...
    date = models.DateTimeField()
    price = models.DecimalField(max_digits=10, decimal_places=2)
    location = models.CharField(max_length=255, db_collation='SQL_Latin1_General_CP1_CI_AS')
